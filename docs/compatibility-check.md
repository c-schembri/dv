...
path copy. Human and JSON output render the same batch. JSON uses event schema 23;
...
therefore occupies 768 stack bytes. The 270,226-byte release manifest is
